...
<head>
    ...
    <style>
        ...
        .custombox{
            ...
            cursor: pointer;
            box-shadow: 5px 10px 18px 1px #0e0e0edb;
            /* width: 30%; */
            margin: 20px;
            float: left;
            min-height: 130px;
...
<div style="margin-top: 5%;margin-bottom: 5%" id="main">
    ...
    margin-left: 0%;" src="./images/arrow.png" alt="arrow image not found">
            ...
            <div style="    position: relative;display: block;padding: 10px 15px;margin-bottom: -1px;background-color: #fff;border: 1px solid #ddd;" class="list-group-item list-group-item-action flex-column align-items-start classtag_for_inder custombox">
                <div class="d-flex w-100 justify-content-between">
                    <h3 style="text-decoration: none;font-size: 15px;font-family: monospace;font-weight: bold;" class="mb-1";><i class="glyphicon glyphicon-tags" style="font-size: 12px;color: #d8031f"></i><em style="margin-left: 8px"><%=rs2.getString("topic")%></em></h3>
    ...
    margin-top: -40px;" class="text-muted badge badge-danner pull-right"><img style="width: 20px" src="./images/date.png" alt=""> <%=rs2.getDate("date_asked")%></small>
                ...
                <button type="button" class="ansBtn" data-toggle="modal" onclick="getQuestion(this)" data-target="#answerModal" <%if(AnsweredDao.hasAnswered(rs2.getInt("q_id"),a.user_id)){%> style="display:none;" <%}%>><span style="top:3px;" y class="glyphicon glyphicon-edit"></span></button>
               ...
               while (resultSet1.next()){
                %>
                <button type="link" class="ansBtn" href="#<%=q_id%>" data-toggle="collapse"><span style="top:3px;" class="glyphicon glyphicon-eye-open"></span></button>
                <div style="
                font-size: 15px;
    font-family: monospace;
    border-radius: 10px;
