...
<head>
    ...
    <style type="text/css">
        ...
        .modal-header {
            font-family: monospace;
            font-weight: bold;
            background-color: #6c0110 !important;
            border-radius: 5px 5px 0 0;
            color: white;
        }
        .modal-body {
...
<div style="height:60px; background-color: #101010" class="navbar navbar-inverse navbar-fixed-top">
    ...
    padding-left: 40px;">
        <div class="navbar-header" style="margin-top: 6px">
            ...
            font-size: 28px;
            color: #9d9d9d;"href="home.jsp" class="pull-left navbar-brand">Questagram</a>
                ...
                <li>
                    ...
                    <%--<form onsubmit="search()" class="navbar-form" role="search">--%>
                        <div class="input-group">
                            ...
                            <input class="form-control search navbar-form" type="text" name="srch-term" onkeyup="search()" placeholder="Search for a Question or Topic" id="srch-term">
                        </div>
                    <%--</form>--%>
                </li>
