...
<head>
    ...
    .form-container
    {
        background-color: #1f09004a !important;
        box-shadow: 5px 10px 18px 1px #0e0e0e;
    }
    </style>
</head>
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
            ...
            <form style=";background:url()" class="form-container" action="Register" method="post">
                <h1 style="color: white;text-align: center;" id="heading">Sign Up</h1><hr style="border-color: white;">
