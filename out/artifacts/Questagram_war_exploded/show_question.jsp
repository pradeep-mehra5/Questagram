...
<div class="fixedposition" style="color: white;
    ...
    font-weight: bold;
    position: fixed;
    background: rgba(216, 3, 31, 0.67);
    top: 60px;"class="media">
...
color: white;
    ...
    <button style="border: none" id="editClick" class="your_likes pull-right"><span class="glyphicon glyphicon-pencil"></span></button>
    </div><%}%>
